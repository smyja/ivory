...
const cardData = [
    {
        title: "Email",
        content: "Permanently remove your Personal Account and all of its contents from Infrarail. This action is not reversible, so please continue with caution.",
        inputType: "text",
        buttonText: "Save",
        buttonColor: "black"
    },
            ...
            {cardData.map((card, index) => (
                <Card key={index} padding="lg" radius="md" withBorder mb={20}>
                    ...
                    <Group justify="space-between" mt="xs" >
                        <Text fw={500} c={"dimmed"}>We will email you to verify the change.</Text>
